<?php bunch_global_variable(); 
	...
	$layout = carshire_set( $settings, 'author_page_layout', 'right' );

	$sidebar = carshire_set( $settings, 'author_page_sidebar', 'blog-sidebar' );

	$view = carshire_set( $settings, 'author_page_view', 'list' );
	...
	$bg = carshire_set($settings, 'author_page_header_img');

	$title = carshire_set($settings, 'author_page_header_title');
