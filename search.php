<?php bunch_global_variable();
	...
	$layout = carshire_set( $settings, 'search_page_layout', 'right' );

	$sidebar = carshire_set( $settings, 'search_page_sidebar', 'blog-sidebar' );

	$view = carshire_set( $settings, 'search_page_view', 'list' );
	...
	$bg = carshire_set($settings, 'search_page_header_img');

	$title = carshire_set($settings, 'search_page_header_title');
		...
		<div class="row clearfix">
			...
			<?php else : ?>
					...
					<div class="<?php echo esc_attr($classes);?> blog_post_area">
						...
						<p><?php esc_html_e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.', 'carshire' ); ?></p>
