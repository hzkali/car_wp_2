...
//Services
carshire_vc_map( array(
			"name" => esc_html__("bbPress Forums", 'carshire'),
			"base" => "bbp-forum-index",
			"class" => "",
			"category" => esc_html__('Jollyall', 'carshire'),
			"icon" => 'faqs' ,
			"params" => array(				
				array(
				   "type" => "textfield",
				   "holder" => "div",
				   "class" => "",
				   "heading" => esc_html__("Forum", 'carshire'),
				   "param_name" => "forum",
				   "description" => ''
				),
...
function vc_theme_vc_row($atts, $content = null) {
   ...
   extract(shortcode_atts(array(
	...
	//$boxed = carshire_set( _WSH()->option(), 'boxed_layout' );
...
$param = array(
  ...
  "holder" => "div",
  "class" => "",
  "heading" => esc_html__("Container", 'carshire'),
  "param_name" => "container",
  "value" => array('Center Page'=>true),
  "description" => esc_html__("Choose whether you want to add a container before row or not.", 'carshire')
);
